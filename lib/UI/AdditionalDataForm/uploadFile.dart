...
class AdditionalDataUploadForm extends StatefulWidget {

  String custom_requirement_id;
  AdditionalDataUploadForm({Key key, this.custom_requirement_id}): super(key: key);

  @override
  _AdditionalDataUploadFormState createState() => _AdditionalDataUploadFormState();
}

class _AdditionalDataUploadFormState extends State<AdditionalDataUploadForm> {
  String _fileName;
  String _path;
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          height: 55.0,
//                        width: 600.0,
          child: _isLoadingSecondary ? Center(child: SizedBox(height: 25.0, width: 25.0, child: CircularProgressIndicator(valueColor : AlwaysStoppedAnimation(Colors.white), strokeWidth: 2.0,),),) : Row(
