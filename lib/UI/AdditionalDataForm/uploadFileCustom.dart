...
class CustomFormUploadButton extends StatefulWidget {

  String custom_requirement_id;
  CustomFormUploadButton({Key key, this.custom_requirement_id}): super(key: key);

  @override
  _CustomFormUploadButtonState createState() => _CustomFormUploadButtonState();
}

class _CustomFormUploadButtonState extends State<CustomFormUploadButton> {
  String _fileName;
  String _path;
